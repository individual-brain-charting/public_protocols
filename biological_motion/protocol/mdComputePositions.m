function walkerdots = mdComputePositions(md2D, markers, tw, speed, xcenterw, ycenterw, fr, invert, jitter);
...
for i=1:markers
    ...
    walkerdots(1,i)=md2D(wfr,i,1)+xcenterw+jitter(1);
    walkerdots(2,i)=md2D(wfr,i,2)+ycenterw+jitter(2);
end;
