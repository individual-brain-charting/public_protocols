...
% Define paths:
imgdir = fullfile(pwd, '/');
logdir = fullfile(imgdir, 'log_files/vSTM/');

% Define filenames of input files and result file:
datafilename = strcat(logdir, 'vWM_',num2str(subject),'_',num2str(run_group),'_',num2str(log_file),'.dat'); % name of data file to write to
...
try
    ...
    while isempty(keycodes) || ~keycodes(triggerKey)
        ...
        str3 = sprintf("Appuyez sur le bouton sous votre INDEX si différent.\n\n"); 
        str4 = sprintf("Appuyez sur le bouton sous votre MAJEUR si égal.\n\n\n");
...
%             prevTrialTime = GetSecs;
            ...
            if ((trialn == 72) ); %72 144
                ...
                str2 = sprintf("Appuyez sur le bouton sous votre INDEX si différent.\n\n"); 
                str3 = sprintf("Appuyez sur le bouton sous votre MAJEUR si égal.\n\n\n");
