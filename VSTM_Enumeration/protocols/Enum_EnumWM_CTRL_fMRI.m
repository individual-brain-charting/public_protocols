...
% Define paths:
imgdir = fullfile(pwd, '/');
logdir = fullfile(imgdir, 'log_files/enumeration/');
...
datafilename = strcat(logdir, 'Enum_',num2str(subject),'_',num2str(run_group),'_',num2str(log_file),'.dat'); % name of data file to write to
