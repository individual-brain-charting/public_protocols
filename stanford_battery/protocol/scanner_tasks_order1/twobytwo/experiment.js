...
getResponses = function(order) {
  var response_keys = {key: [89,71], key_name: ["Index", "Majeur"]}
  if (order == 2) {
    response_keys= {key: [71,89], key_name: ["Majeur", "Index"]}
  }
...
var task_setup_block = {
  ...
  prompt_task_list = '<strong>Couleur</strong> or <strong>Orange-Bleu</strong>: ' +
