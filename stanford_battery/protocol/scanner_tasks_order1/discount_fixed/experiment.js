...
for (var i = 0; i < stim_index.length; i++) {
  ...
  stim_html[i] =
      ...
      '<div class = delbox style = "color:white">'+ options.later_del[index]+' jours</div></div>'
}
...
var instructions_block = {
  ...
  stimulus: '<div class = centerbox><div class = center-text><font size="+3">Choisissez entre <strong>20\u20AC aujourd\'hui</strong> ou l\'option presentee.<br><strong>Index:</strong> Accepter l\'option a l\'ecran (rejeter 20\u20AC aujourd\'hui). <br><strong>Majeur:</strong> Rejeter l\'option a l\'ecran (accept 20\u20AC today)<br>Nous commencerons par un essai d\'entrainement.</font></div></div>',
  is_html: true,
  timing_stim: -1, 
  timing_response: -1,
