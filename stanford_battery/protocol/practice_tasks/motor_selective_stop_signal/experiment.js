...
var choice_order = 0 // Change value if you have to restart the task
...
'<div class = centerbox><div class = center-text><i>Fin<br />Permutation index: ' + permutation_index + '<br />SSD: ' + SSD + '</i></div><br/></div>'
 var end_block = {
	type: 'poldrack-single-stim',
	stimulus: '<div class = centerbox><div class = center-text><i>Fin<br />SSD: ' + SSD + '<br /></i></div><br/></div>',
	is_html: true,
	choices: [32],
	timing_response: -1,
	response_ends_trial: true,
