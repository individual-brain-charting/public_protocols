...
assert(session_type in ['1', '2', '3', 'pilot']), \
    "Not valid arg for session id. Please use select either 1, 2 or pilot."
...
#
# =============================================================================
exp = design.Experiment(setting["exp_name"],
...
film_list = [input_path + '/' + i[0] + '.' + setting["ext"] for i in
             csv.reader(open(setting["inputs_filenames"] + '_' +
             session_type + '.csv'))]
...
# Define list of inputs filenames
film_list = [input_path + '/' + i[0] + '.' + setting["ext"] for i in
             csv.reader(open(setting["inputs_filenames"] + '_' + session_type
             + '.csv'))]
