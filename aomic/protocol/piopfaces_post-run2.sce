...
{"P12.avi", "A-M08.avi", "Surprise-15.avi", "N-F10.avi", "Embarrass-04.avi", "C07.avi"}; 
...
###################################### TRIAL LOOP ############################################
	...
	if (vidname=="C07.avi" || vidname=="P12.avi") then
	code = 100; 
	elseif (vidname=="Embarrass-04.avi" || vidname=="Surprise-15.avi") then
	code = 200;
	elseif (vidname=="N-F10.avi" || vidname=="A-M08.avi") then
	code = 300;
	end;
