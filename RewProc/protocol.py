"""
Script to run IBC implementation of reversal learning task from O'Doherty lab.
Imports from config.py, initTask.py, runBandit.py
...
if len(sys.argv) == 3:
    ...
    RunNo = sys.argv[2] # second argument from command line
else:
