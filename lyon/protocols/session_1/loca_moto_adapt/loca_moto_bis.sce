...
text { caption = "BOUGEZ LES YEUX SANS BOUGER LA TETE"; font = $my_font; font_color = 250,250,250; font_size = $my_font_size; text_align = align_center;} c_yeux;
picture {
   text c_yeux;
   x = 0;
   y = 0;   
