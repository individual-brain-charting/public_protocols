scenario = "loca_visu_version_ts2";   
...
pcl_file = "loca_visu_version2_ts.pcl";
...
text { caption = "+";  font_color = 0,0,0; font_size = 40; text_align = align_center;} c_pause;
picture {
   text c_pause;
   x = 0;
   y = 0;   
...
trial {
   start_delay = 0;
   trial_duration = $my_pause_duration;
   trial_type = fixed ;
   
   stimulus_event {
      picture p_pause;
      time = 0;
      duration = $my_pause_duration; 
		code = "Bfix";
		port_code = 110;
   };
} baselinefix;
